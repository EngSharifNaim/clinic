...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            <input type="hidden" id="urlToChangeStatus" value="{{url(getLocal()."/admin/changeStatus/doctors")}}">
                        </div>
                    </div>
                </div>
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/doctors')}}">
                        <div class="row">
                            <div class="col-md-4">
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/doctors_changeStatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/doctor/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        ...
        function delete_adv(id,iss_id, e) {
            //alert(id);
            e.preventDefault();
            var url = '{{url(getLocal()."/admin/doctor")}}/' + id;
