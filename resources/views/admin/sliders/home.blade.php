...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            <input type="hidden" id="urlToChangeStatus" value="{{url(getLocal()."/admin/changeStatus/sliders")}}">
                        </div>
                    </div>
                </div>
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/sliders')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/sliders')}}" type="submit"
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/sliders_changeStatus")}}">
