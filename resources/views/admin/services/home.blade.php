                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            <input type="hidden" id="urlToChangeStatus" value="{{url(getLocal()."/admin/changeStatus/services")}}">
                        </div>
                    </div>
                </div>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/service/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        ...
        function delete_adv(id,iss_id, e) {
            //alert(id);
            e.preventDefault();
            var url = '{{url(getLocal()."/admin/service")}}/' + id;
