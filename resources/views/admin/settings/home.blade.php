                ...
                <form class="form-horizontal" method="post"
                    ...
                    <div class="box-body">
                        ...
                        @endforeach
                         ...
                         @foreach($locales as $locale)
                            <div class="form-group">
                                <label class="col-sm-2 control-label">our_vision_{{$locale->lang}} {{$locale->name}}</label>
                                <div class="col-sm-10">
                                    <input type="text" name="our_vision_{{$locale->lang}}" required
                                           value="{{$setting->translate($locale->lang)->our_vision}}"
                                           class="form-control"
                                           placeholder="our_vision {{$locale->name}}">
                                </div>
                            </div>
                        @endforeach
                         ...
                         @foreach($locales as $locale)
                            <div class="form-group">
                                <label class="col-sm-2 control-label">our_mision_{{$locale->lang}} {{$locale->name}}</label>
                                <div class="col-sm-10">
                                    <input type="text" name="our_mision_{{$locale->lang}}" required
                                           value="{{$setting->translate($locale->lang)->our_mision}}"
                                           class="form-control"
                                           placeholder="our_mision {{$locale->name}}">
                                </div>
                            </div>
                        @endforeach
                        @foreach($locales as $locale)
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="clients" value="{{$setting->clients}}"
                                       class="form-control" placeholder="Clients">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2" style="float: left;text-align: right">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="projects" value="{{$setting->projects}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="initiatives" value="{{$setting->initiatives}}"
                                       class="form-control" placeholder="initiatives">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-2" style="float: left;text-align: right">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">imageback: </label>
                            <div class="col-md-4">
                                <div class="fileinput-new thumbnail"
                                     onclick="document.getElementById('imageback').click()" style="cursor:pointer">
                                    <img src="{{$setting->imageback}}" id="imageback"></div>
                                <div class="btn fileinput-exists btn-azure"
                                     onclick="document.getElementById('imageback').click()"><i
                                            class="fa fa-pencil"></i>{{' Select Image'}}
                                </div>
                                <input type="file" class="form-control" name="imageback" value="{{$setting->imageback}}" id="imageback" style="display:none">
                            </div>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="fileinput-new thumbnail"
                                    ...
                                    <img src="{{$setting->image}}" id="image"></div>
                                <div class="btn fileinput-exists btn-azure"
                                     onclick="document.getElementById('image').click()"><i
                                            class="fa fa-pencil"></i>{{' Select Image'}}
                                </div>
                                <input type="file" class="form-control" name="image" value="{{$setting->image}}" id="image" style="display:none">
                            </div>
                        </div>
